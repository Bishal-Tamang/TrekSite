      ...
      <div className="flex items-center">
        <div>
          <ul
            className={` absolute transition-all duration-500 ease-in ${
              isMenuOpen
                ? " flex flex-col items-center rounded-2xl md:rounded-none  bg-white w-full left-0 top-[100%] pl-4 pt-4 pb-10 z-10"
                : "hidden"
            } 
        ...
        <div className="flex border-2 items-center justify-between rounded-lg border-[#CCF5E1] h-[32px] w-[61px]  p-[2px] cursor-pointer">
          ...
          <img
            src={User}
            alt="user"
            className="bg-[#CCF5E1] rounded-[20px] rounded-b-[20px] p-1 h-[28px] ml-2"
          />
        </div>
      </div>
    </div>

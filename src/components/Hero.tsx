...
const Hero = () => {
  ...
  return (
    <div className="xl:mx-24 mx-4 md:mx-8 lg:mx-16 relative mb-24">
      ...
      <div 
        className={`flex py-1 md:py-4 md:pl-8 pl-2 md:pr-4 pr-1 bg-white items-center justify-end md:justify-center lg:justify-between ${inputField ? 'lg:gap-12' : 'lg:gap-0'} rounded-[20px] drop-shadow-xl absolute 2xl:left-[35%] xl:left-[25%] md:left-[27%] lg:left-[20%] left-[12%] md:bottom-[-7%] bottom-[-5%]`}
      ...
      >
        {inputField === false ? (
          ...
          <div className="w-full">
            <input type="text" className="w-[150%] p-4 rounded-xl font-[Manrope] outline-none" placeholder="Boudha Stupa, Kathmandu, Nepal"/>
          </div>
        ) : (
          null
        )}

  ...
  return (
    <div>
      <div className="plans--section mx-4 lg:mx-36 mt-8 text-center">
        <div
          className="top--section pt-28"
          style={{
            backgroundImage: `url(${ghostbg})`,
        ...
        >
          ...
          <div className=" flex justify-center mb-24">
            <p className="font-['IBM_Plex_Sans'] font-[400] text-gray-700 text-base md:w-[70%] 2xl:w-[45%]">
              ...
              desire from the trip to Nepal and suit your itinerary according to
              your wish. We might not be the genie ou saw in moveis but we'll
              make all wishes come true in every possible manner from the trip
              with us.
            </p>
          </div>
        </div>

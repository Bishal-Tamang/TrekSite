  ...
  return (
    <div ref={ref}>
      <div className="xl:mx-24 mx-4 md:mx-8 lg:mx-16 2xl:mx-32 my-8 ">
        {/* <p className="text-gray-600 font-['IBM_Plex_Sans'] lg:text-sm text-xs mb-4 2xl:mb-8">
          Home / Destination / Kathmandu / Family tour / Kathmandu tour-11 days
          10 nights
        </p> */}
      ...
      <ol role="list" className="flex items-center space-x-1">
        ...
        <div className="heading--section mt-6 2xl:mt-8 flex flex-col md:flex-row justify-between">
          ...
          <div className="right--section flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div>
              {/* <button className="bg-[#19A948] text-white py-3 px-4 rounded-md ">
                Enquiry now
              </button> */}
              <EnquiryTab />
            </div>
        ...
        <div className="image--container relative flex flex-col md:flex-row gap-2 justify-center my-6 2xl:my-12 w-full h-full">
            ...
            <img src={img2} alt="" className="object-cover rounded-lg h-[250px] md:h-[50%]"/>
            <img src={img3} alt="" className="object-cover rounded-lg h-[250px] md:h-[50%] pt-2"/>
            </div>

            <button type="button" className="hidden lg:block absolute right-[5%] bottom-[5%] 2xl:right-[16%] 2xl:bottom-[2%] cursor-pointer bg-[#E6FAF0] opacity-70 hover:opacity-100 rounded-md py-3 px-4 font-['IBM_Plex_Sans'] font-[500] text-gray-700 text-base">View all photos</button>
          
        </div>

       <div className="responsive--button w-full flex justify-center lg:hidden mb-4">
       <button type="button" className="mx-auto bg-[#19A948] rounded-md py-3 px-4 font-['IBM_Plex_Sans'] font-[500] text-white text-base">View all photos</button>
       </div>

      <div className={fix ? 'hidden w-auto overflow-x-hidden md:block lg:-mx-24 2xl:-mx-36 lg:px-24 px-8 2xl:px-36 outline-none border-none md:-mx-8 sticky top-0 py-6 mb-2 z-50 bg-white drop-shadow-md' : 'hidden'}>
      <div className="responsive--sticky--nav">
          <div className="parent-container flex justify-between w-full">
              <div className="left--section flex gap-4 2xl:gap-8 justify-between items-center cursor-pointer">
                {stickyNav.map( (item,index) => (
                  ...
                  style={activeState === index || inView[index] ? {
                    color: '#19A948' ,
              ...
              <div className="right--section">
                <div className="price flex items-center justify-between gap-6">
                  <p className="text-gray-600 font-['IBM_Plex_Sans'] font-[400] lg:text-base text-sm"><span className="font-['Manrope'] font-[700] lg:text-lg text-base text-gray-800">Rs. 20,000</span> / person</p>
       ...
       <div className="overview--section mb-6 mt-20 2xl:my-12" id="overview">
            ...
            <h1 className="font-['Manrope'] font-[700] text-gray-700 text-lg">Overview</h1>
            <hr className="border-gray-300 w-full"/>
            </div>
            <p className="font-['IBM_Plex_Sans'] font-[400] text-gray-600 text-base">Everest Base Camp Trek gives you an opportunity to visit some of the high-altitude destinations that only a handful of world’s population ever gets to visit. Following the footsteps of Edmund Hillary and Tenzing Norgay, trek along the foothills of Himalayan mountains including the world’s highest, Mount Everest (8,848 m). Stand beneath their massive shadows and feel humbled. En route experience Sherpa hospitality and culture, Buddhist spiritualism (the trails are adorned with mani stones, chortens and colorful prayer flags) and amazing mountain scenery. NOTE: The Lukla flights to and from Kathmandu had been shifted to Manthali Airport, Ramechhap district in 2019 & 2020 due to heavy air traffic during peak trekking season (Mar, Apr, May, Oct, Nov). But, for now, the flights are directly between Kathmandu and Lukla. Extra cost would be applicable if airlines don't provide any shuttle services or if you want to take a private vehicle instead of the shared ride provided by the airlines</p>
        </div>

        <div className="activity--section mb-6 mt-20 2xl:my-12" id="details">
         <div className="flex items-center mb-4">
         <h1 className="font-['Manrope'] font-[700] md:w-[30%] lg:w-[20%] 2xl:w-[11%] w-full text-gray-700 text-lg">About this activity</h1>
          <hr className="border-gray-300 w-full"/>
         </div>
          ...
          <div className="flex flex-col md:flex-row justify-between ">
            <div className="left--section flex justify-between md:block w-full mb-4 md:mb-0">
              ...
              <div className="left-top-section mb-4 md:mb-16 lg:mb-4">
                ...
                <h1 className="text-gray-700 font-['IBM_Plex_Sans'] font-[500] text-base"> Duration</h1>
                </div>
                <p className="font-['IBM_Plex_Sans'] font-[400] text-base text-gray-600">11 days 10 nights</p>
              </div>

              <div className="left-bottom-section">
                <div className="flex items-center gap-2 mb-1">
                <img src={phone} alt="" className="text-gray-700"/>
                <h1 className="text-gray-700 font-['IBM_Plex_Sans'] font-[500] text-base"> Help? Call us on</h1>
                </div>
                <p className="font-['IBM_Plex_Sans'] font-[400] text-base text-gray-600">000-0800-100-6999</p>
              </div>
            </div>
            ...
            <div className="right--section w-full">
              ...
              <h1 className="text-gray-700 font-['IBM_Plex_Sans'] font-[500] text-base"> Free cancellation</h1>
              </div>
              <p className="font-['IBM_Plex_Sans'] font-[400] text-base text-gray-600">If you cancel at least 7 day(s) before the scheduled departure time, you will receive a full refund.If you cancel between 3 and 6 day(s) before the scheduled departure time, you will receive a 50% refund.If you cancel within 2 day(s) of the scheduled departure, you will receive a 0% refund.</p>
            </div>
          </div>
        </div>
        ...
        <div className="included--section mb-6 mt-20 2xl:my-12">
          <div className="flex items-center mb-3">
            <h1 className="font-['Manrope'] font-[700] w-full md:w-[30%] lg:w-[15%] 2xl:w-[10%] text-gray-700 text-lg ">What's included</h1>
            <hr className="w-full border-gray-300"/>
          </div>

          <div className="w-full">
            <ul className="list-disc my-3 px-3">
              <li className="mb-2 text-gray-600 font-['IBM_Plex_Sans'] font-[400] text-base">A comprehensive first-aid kit and arragements for emergency medical evacuation in worst scenario.</li>
              <li className="mb-2 text-gray-600 font-['IBM_Plex_Sans'] font-[400] text-base">3-star twin-share accommodation in Kathmandu (2 nights); breakfast included</li>
              <li className="mb-2 text-gray-600 font-['IBM_Plex_Sans'] font-[400] text-base">Food, accommodation, salary, insurance, equipment and medicine for all staff</li>
              <li className="mb-2 text-gray-600 font-['IBM_Plex_Sans'] font-[400] text-base">First-aid trained, government licensed English-speaking trekking guide</li>
              <li className="mb-2 text-gray-600 font-['IBM_Plex_Sans'] font-[400] text-base">All our government taxes, tourist service charges, official expenses</li>
              <li className="mb-2 text-gray-600 font-['IBM_Plex_Sans'] font-[400] text-base">Porter service for 11 days (1 porter for 2 clients).</li>
              <li className="mb-2 text-gray-600 font-['IBM_Plex_Sans'] font-[400] text-base">Guesthouse accommodation during the trek (mostly twin-share and occasionally dormitory-style rooms)</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 mb-3">
            <h1 className="font-['Manrope'] font-[700] text-gray-700 text-lg">Reviews</h1>
            <hr className="w-full border-gray-300"/>
        </div>

        <div className="testimonial--section mb-6 mt-20 2xl:my-12 xl:-mx-24 -mx-4 md:-mx-8 lg:-mx-16 2xl:-mx-32">
        <Carousel className="mx-3 my-6"
       ...
       <button 
        ...
        <div className="similar--section">
          ...
          <h1 className="font-['Manrope'] font-[700] text-2xl 2xl:text-3xl text-gray-800 mb-2">Similar tours</h1>
          <p className="font-['IBM_Plex_Sans'] font-[400] text-base text-gray-600 ">These are the similar experience that traveller viewed while viewing this tour</p>
          </div>

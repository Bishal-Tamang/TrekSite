  ...
  return (
    <div className="DestinationDetails mb-24 ">
      ...
      <div className="things--slider mt-24 xl:mx-24 mx-4 md:mx-8 lg:mx-16 mb-28">
        ...
        <DestinationThingsCarousel data={SmolSliderData} />
      </div>
        ...
        <div className="w-full mt-2 mb-8">
          <div className="flex justify-between items-center">
            <p className="font-['IBM_Plex_Sans'] font-[400] text-base text-gray-600">
              Book these experiences for a close-up look at {state?.title}
            </p>
            <button
              type="button"
              className='hidden border-[#12A347] border-2  rounded-lg py-2 px-[14px] font-["IBM_Plex_Sans"] font-[400] text-base text-[#12A347] lg:flex gap-2 items-center hover:text-white hover:bg-[#12A347] transition duration-700'
      ...
      <div className="text-center mb-28 xl:mx-24 mx-4 md:mx-8 lg:mx-16">
        <h1 className="font-['Manrope'] font-[700] text-2xl text-gray-800 mb-8">
          Top Attraction in {state?.title}
        </h1>
      ...
      <div className="Things---to---do---section---copied mb-28 mt-28 xl:mx-24 mx-4 md:mx-8 lg:mx-16">
        ...
        <div className="w-full mt-2 mb-8">
          <div className="flex justify-between items-center">
            ...
            <button
              type="button"
              className='hidden border-[#12A347] border-2 py-2 px-[14px] font-["IBM_Plex_Sans"] font-[400] text-["16px"] text-[#12A347] lg:flex gap-2 items-center hover:text-white hover:bg-[#12A347] rounded-xl transition duration-700'
            >
              View all <AiOutlineArrowRight size={20} />
            </button>
          </div>
        ...
        <div>
          ...
          <div className="flex w-full items-center justify-center mt-6">
            <button
              type="button"
              className='flex gap-2 border-[#12A347] border-2 py-2 px-[14px] font-["IBM_Plex_Sans"] font-[400] text-["16px"] text-[#12A347] lg:hidden hover:text-white hover:bg-[#12A347] rounded-xl transition duration-700'
            >
              View all <AiOutlineArrowRight size={20} />
            </button>
          </div>
      ...
      <div className=" xl:mx-24 mx-4 md:mx-8 lg:mx-16">
        <button
          className="mx-auto flex items-center gap-3 border text-[#12A347] font-['IBM_Plex_Sans'] border-[#12A347] rounded-lg py-2 px-3 hover:text-white hover:bg-[#12A347] transition duration-700"
